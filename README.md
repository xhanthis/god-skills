...
- **Every skill's final message** ends with **god-ally's** status callout — Zen Score against the week, intensity against the month, dollars burned today and over 30 days (`zen-report.js --line`) — and one more 🧘 line whenever it has something specific: stop for tonight, take a break, don't start this before the meeting, eat, go deep now. On a strong signal it asks before you continue.
