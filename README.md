...
- **Vague request** ("order amount is wrong") → **god-ceo** investigates the codebase, reconstructs the real problem, decides if it is worth doing, and picks the minimum set of specialists and their order.
