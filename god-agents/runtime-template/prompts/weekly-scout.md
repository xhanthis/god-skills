...
Good: "`store_orders` has 4,100 rows across 62 stores; the ordering flow is
decoupled from the order engine (3 shared tables, no shared auth).
...
- **Medium** — touches customer or partner experience, removes recurring manual work,
