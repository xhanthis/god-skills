---
name: god-write
description: "Humanize text: strip AI-isms and restore real human voice. Load when the user asks to humanize, de-AI, de-slop, or un-ChatGPT text; rewrite a draft (blog post, essay, PR description, docs, memo, email, tweet, resume bullet) to sound natural; match their voice; or review prose for AI tells before publishing. Also apply to your own user-facing prose."
license: MIT
author: Siqi Chen (@blader, https://github.com/blader/humanizer); adapted as "God Write" for Claude Code
---

# God Write: Remove AI Writing Patterns
