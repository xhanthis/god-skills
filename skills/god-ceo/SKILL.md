...
```
  ...
  Why        refunds fail for 1 in 50 customers — about ₹40k a week
             the fix is 2 days; doing nothing costs more by Friday
             nothing else this week saves as much

  Before     customer asks for refund → stuck for 3 days → angry call
  After      customer asks for refund → money back in 1 hour
