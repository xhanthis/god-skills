...
Security-sensitive implementation, or anything touching guest/owner PII → **god-security**. Financial logic → **god-cfo** for validation. Legal/compliance-sensitive code → **god-pl**.
