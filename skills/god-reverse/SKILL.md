...
- **Never fabricate a signal.** "The API returns `orderId`" requires you to have seen it. Unknown internals are reported as unknown, with the probe that would resolve them.
