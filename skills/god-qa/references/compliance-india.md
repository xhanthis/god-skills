...
- **DPDP Act 2023 + ISO 27001 (guest and homeowner data):** lawful purpose stated for every new personal field; consent captured where required and revocable; retention named; access, correction and erasure paths exist; data principal notices updated when a new use is added; breach path known.
